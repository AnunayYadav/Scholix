...
export const LEVEL_THRESHOLDS: LevelThreshold[] = [
  ...
  { level: 5, minXP: 2000, maxXP: 3499, title: 'Master', icon: '👑' },
  { level: 6, minXP: 3500, maxXP: 6499, title: 'Legend', icon: '🏆' },
  { level: 7, minXP: 6500, maxXP: 9999, title: 'Grandmaster', icon: '🎖️' },
  { level: 8, minXP: 10000, maxXP: Infinity, title: 'Immortal', icon: '♾️' },
];
