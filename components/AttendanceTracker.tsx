...
const SubjectSkeleton = () => (
  <div className="glass-panel p-5 md:p-8 rounded-[32px] md:rounded-[40px] border border-slate-200 dark:border-white/5 bg-white dark:bg-[#0a0a0a]/40 animate-pulse min-h-[160px]">
    ...
    <div className="max-w-5xl mx-auto space-y-6 md:space-y-8 animate-fade-in pb-24 px-4 md:px-0">
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-4 md:gap-6">
        ...
        <div className="flex flex-wrap items-center gap-2 md:gap-3">
              ...
              {wipingAll ? (
                <div className="flex items-center bg-red-600 rounded-2xl overflow-hidden shadow-xl animate-fade-in">
                  <button
                    ...
                    className="px-3 md:px-4 py-2.5 md:py-3 text-[11px] sm:text-xs font-bold text-white/70 hover:text-white"
                  >
                    No
                  </button>
                  <button
                    onClick={executeClearAll}
                    className="px-4 md:px-6 py-2.5 md:py-3 bg-white text-red-600 font-black text-[11px] sm:text-xs uppercase tracking-widest hover:bg-red-50"
                  >
                    Wipe All Data?
                  </button>
                </div>
                ...
                <button
                  ...
                  className="flex items-center space-x-2 px-4 md:px-6 py-2.5 md:py-3 bg-slate-100 dark:bg-[#0a0a0a] rounded-2xl text-[11px] sm:text-xs font-bold text-red-500 hover:bg-red-500 hover:text-white transition-all shadow-sm"
                >
          ...
          <button
            ...
            className={`flex items-center space-x-2 px-4 md:px-6 py-2.5 md:py-3 rounded-2xl text-[11px] sm:text-xs font-bold transition-all shadow-sm ${showArchived ? 'bg-orange-600 text-white' : 'bg-slate-100 dark:bg-[#0a0a0a] text-slate-600 dark:text-slate-400'}`}
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-5 items-end">
          <div className="md:col-span-3">
            ...
            <input
              ...
              className={`w-full bg-slate-100 dark:bg-[#0a0a0a] border rounded-2xl px-5 py-3.5 md:py-4 text-slate-800 dark:text-white outline-none transition-all font-bold text-sm shadow-inner ${showValidation && !newSub.name.trim()
          ...
          <div className="md:col-span-3">
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                className="w-full bg-slate-100 dark:bg-[#0a0a0a] border border-transparent rounded-2xl px-3 py-3.5 md:py-4 text-slate-800 dark:text-white outline-none focus:ring-2 focus:ring-orange-600 transition-all text-sm text-center font-bold shadow-inner"
              />
                    ...
                    {isDeleting ? (
                      <div className="flex items-center gap-1 animate-fade-in">
                        <button
                          ...
                          className="px-2 py-1.5 bg-slate-100 dark:bg-white/5 text-[11px] sm:text-xs font-medium text-slate-400 rounded-lg hover:text-white transition-colors border-none"
                        >
                          No
                        </button>
                        <button
      ...
      {!isInitializing && filteredSubjects.length === 0 && (
        <div className="text-center py-20 md:py-24 bg-slate-50 dark:bg-white/5 rounded-[32px] md:rounded-[48px] border-4 border-dashed border-slate-200 dark:border-white/5">
          ...
          <p className="font-black text-slate-400 uppercase tracking-[0.3em] text-[11px] sm:text-xs">
      ...
      {isEditModalOpen && editingSubject && createPortal(
        ...
        >
          <div ref={editModalRef} className={`bg-white dark:bg-[#0a0a0a] rounded-[32px] md:rounded-[40px] w-full max-w-sm shadow-[0_32px_128px_rgba(0,0,0,0.8)] border border-slate-200 dark:border-white/10 relative overflow-hidden flex flex-col animate-slide-up ${isClosing ? 'closing' : ''}`}>
