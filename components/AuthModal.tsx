    ...
    try {
      if (mode === 'login') {
        ...
        if (step === 'form') {
          ...
          // Set a temporary flag with timestamp to prevent the App from showing the verification modal instantly
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 animate-fade-in">
                      ...
                      <div>
                        ...
                        <div className="relative group">
                          ...
                          <input
                            type="text" required value={regNo} onChange={e => setRegNo(e.target.value.toUpperCase().replace(/[^A-Z0-9]/g, '').slice(0, 15))}
                            disabled={loading}
