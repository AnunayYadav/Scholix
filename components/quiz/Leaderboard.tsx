            ...
            <div className="glass-panel p-4 py-6 rounded-[32px] animate-pulse bg-white/40 dark:bg-white/[0.02]">
                <div className="flex items-center justify-between gap-4 px-4">
                    <div className="flex items-center gap-4">
                        <div className="w-10 h-10 bg-slate-200 dark:bg-white/5 rounded-2xl" />
                        <div className="h-6 w-48 bg-slate-200 dark:bg-white/5 rounded-full" />
                    </div>
                </div>
            </div>
        );
    ...
    return (
        <div className="w-full">
            <motion.div 
                layout
                initial={false}
                className="glass-panel overflow-hidden rounded-[32px] border border-slate-200/50 dark:border-white/[0.08] shadow-2xl shadow-slate-200/10 dark:shadow-none bg-white/50 dark:bg-white/[0.02] backdrop-blur-2xl transition-all"
            >
                {/* Expandable Header */}
                <button 
                ...
                >
                    <div className="flex items-center gap-5">
                        ...
                        <div className="flex flex-col">
                            <h3 className="text-lg font-bold text-slate-800 dark:text-white tracking-tight">Study Kings Leaderboard</h3>
                            <div className="flex items-center gap-2">
                                <p className="text-[10px] text-slate-500 dark:text-slate-400 font-semibold uppercase tracking-widest flex items-center gap-1.5">
                    ...
                    <div className="flex items-center gap-3">
                        <span className="text-[10px] font-bold text-slate-400 group-hover:text-orange-500 transition-colors uppercase tracking-widest hidden sm:inline-block">
                            {isExpanded ? 'Collapse' : 'View Full'}
                        </span>
                        <motion.div
                            animate={{ rotate: isExpanded ? 180 : 0 }}
                            transition={{ duration: 0.3 }}
                            className="w-8 h-8 rounded-xl bg-slate-100 dark:bg-white/5 flex items-center justify-center text-slate-400 dark:text-slate-500 group-hover:text-orange-500 group-hover:bg-orange-500/10 transition-all shadow-sm"
                        >
                        ...
                        >
                                            ...
                                            >
                                                    ...
                                                    <div className="relative flex items-center justify-center w-9 h-9">
                                                        ...
                                                        <div className={`w-full h-full rounded-2xl flex items-center justify-center text-xs font-bold transition-all group-hover:scale-105
                                                            ${idx === 0 ? 'bg-gradient-to-br from-amber-300 via-amber-500 to-amber-600 text-white shadow-lg shadow-amber-500/20' : 
                                                              idx === 1 ? 'bg-gradient-to-br from-slate-200 via-slate-400 to-slate-500 text-white shadow-lg shadow-slate-400/20' : 
                                                ...
                                                <td className="px-8 py-5">
                                                    <div className="flex items-center gap-4">
                                                        <div className="relative">
                                                            <div className={`w-12 h-12 rounded-2xl overflow-hidden bg-slate-100 dark:bg-white/5 border-2 transition-all duration-500 group-hover:rotate-2
                                                ...
                                                <td className="px-10 py-5 text-right">
                                                    <div className="flex flex-col items-end gap-1">
                                                        ...
                                                        <div className="w-16 h-1 bg-slate-100 dark:bg-white/[0.05] rounded-full overflow-hidden">
                                                            <div 
                            ...
                            {leaderboard.length === 0 && (
                                <div className="py-16 text-center space-y-4">
                                    <div className="w-16 h-16 bg-slate-100 dark:bg-white/5 rounded-3xl flex items-center justify-center mx-auto text-slate-300 dark:text-slate-700 shadow-inner">
                                    ...
                                    <div className="space-y-1">
                                        <h3 className="text-base font-bold text-slate-900 dark:text-white">Scholar Board Empty</h3>
                                        <p className="text-xs text-slate-500 max-w-[200px] mx-auto">The throne remains unclaimed. Be the first King!</p>
                                    </div>
                                </div>
                            )}

                            <div className="p-4 bg-slate-50/50 dark:bg-white/[0.01] border-t border-slate-100 dark:border-white/[0.05]">
                                <button 
                                    onClick={() => setIsExpanded(false)}
                                    className="w-full py-2 flex items-center justify-center gap-2 text-[10px] font-bold text-slate-400 hover:text-orange-500 transition-colors uppercase tracking-[0.2em]"
                                >
